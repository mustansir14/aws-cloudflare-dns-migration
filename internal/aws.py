...
class AWSClient:
    ...
    def list_unique_hosted_zones(self):
        ...
        print(
            f"After removing duplicates, {len(unique_zones)} unique hosted zones left"
        )
    ...
    def get_zone_by_domain(self, domain: str) -> object:
        zones = self.client.list_hosted_zones_by_name(DNSName=domain, MaxItems="1")[
            "HostedZones"
        ]
    ...
    def create_dns_records(self, zone_id: str, records: List[Dict]) -> object:
        changes = []
